...
async function uploadCredsToMega(credsPath) {
    try {
        const storage = await new Storage({
            email: 'rohitroy742213@gmail.com', // Your Mega A/c Email Here
            password: 'R74221322' // Your Mega A/c Password Here
        }).ready;
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'NOBITA-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://whatsapp.com/channel/0029Vb7VJVYGU3BST66hmd32) 

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [Malvin King GitHub Repo](https://github.com/nobita-web/NOBITA-MD)  

🚀 _Thanks for choosing NOBITA-MD — Let the automation begin!_ ✨`;
